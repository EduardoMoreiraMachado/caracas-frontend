...
const postPizza = async (pizza) => {
    ...
    const url = 'http://127.0.0.1:1206/v1/pizza'
...
const salvarDados = async () => {
    ...
    const urlFoto = "https://upload.wikimedia.org/wikipedia/commons/9/91/Pizza-3007395.jpg" //await uploadImage(image, nameFile)
