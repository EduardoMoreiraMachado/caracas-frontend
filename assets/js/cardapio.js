...
const apiPizzas = async() => {
    ...
    const urlTodasPizzasAPI = 'http://127.0.0.1:1206/v1/pizzas'
...
const apiPizzasByCategoria = async(idCategoria) => {
    ...
    const urlTodasPizzasAPI = `http://127.0.0.1:1206/v1/pizzasCategoria/${idCategoria}`
...
const listarCategorias = async (tipo) => {
    ...
    const url = `http://127.0.0.1:1206/v1/categorias/${tipo}`
